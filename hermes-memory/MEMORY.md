...
§
帛飞特项目（双验收）：甲方=杭州集控总集（PM吴恒、高层蔡总），业主=帛飞特；数睿实际全责执行（PM任可，7月调研另有刘乐；售前朱琳、商务俞亚君）；原报价10万（假设集控PM主责）→售前重估80万（执行全数睿）；核心矛盾=合同责任链（数睿→集控→业主）与实际执行错位；政府验收=主流程跑通（8.13前完成获蔡总认可）、合同验收=业主真正用起来（80万核心工作量）；集控PM决策责任=需求深度把控/政府验收时间与业主对清/业主商务接口；边界文档=98 hermes/帛飞特项目_数睿与集控PM工作边界_20260828.md